...
//           <Link
//             href="/prompt/create"
//             className={`flex py-2 gap-4 items-center ${path === "/prompt/create" ? "bg-gray-700" : ""} text-white hover:bg-gray-700 px-3 rounded-md`}
//           >
...
//           <Link
//             href="/ask-ai"
//             className={`flex py-2 gap-4 items-center text-white ${path === "/ask-ai" ? "bg-gray-700" : ""} hover:bg-gray-700 px-3 rounded-md`}
//           >
